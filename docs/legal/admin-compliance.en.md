...
Sub2API Plus is an independently maintained community fork based on Wei-Shaw/sub2api. It is not an official upstream release and does not imply upstream affiliation, endorsement, support, or trademark permission.
