...
```bash
curl -sSL https://raw.githubusercontent.com/skyqingname/gotocc-router/main/deploy/install.sh | sudo bash -s -- install --version 'v0.2.8+custom.002'
```
...
```bash
sudo ./install.sh install --version 'v0.2.8+custom.002'
```
