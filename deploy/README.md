...
```bash
curl -sSL https://raw.githubusercontent.com/LuckyKuang/sub2api-plus/main/deploy/install.sh | sudo bash -s -- install --version 'v0.1.178+custom.006'
```
...
```bash
sudo ./install.sh install --version 'v0.1.178+custom.006'
```
