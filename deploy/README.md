...
```bash
curl -sSL https://raw.githubusercontent.com/LuckyKuang/sub2api-plus/main/deploy/install.sh | sudo bash -s -- install --version 'v0.1.178+custom.004'
```

Roll back an existing binary installation to an earlier published version:

```bash
curl -sSL https://raw.githubusercontent.com/LuckyKuang/sub2api-plus/main/deploy/install.sh | sudo bash -s -- rollback 'v0.1.178+custom.003'
```
...
```bash
sudo ./install.sh install --version 'v0.1.178+custom.004'
```

Roll back a downloaded-script installation one operation at a time:

```bash
sudo ./install.sh rollback 'v0.1.178+custom.003'
```
