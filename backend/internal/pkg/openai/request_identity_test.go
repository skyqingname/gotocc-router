...
func TestPairCodexClientIdentity(t *testing.T) {
	tests := []struct {
		...
		{name: "originator override 不得由尾部恢复", ua: "cccc/0.142.0 (Ubuntu 22.4.0; x86_64) screen (codex-tui; 0.142.0)", wantOK: false},
		{name: "Codex 家族 override 不得由尾部恢复", ua: "cccc/1.2.3 (Ubuntu 22.4.0; x86_64) term (Codex Desktop; 1.2.3)", wantOK: false},
		{name: "含斜杠的尾部 name 拒绝配对（防自不一致身份）", ua: "foo/1.0 (Codex Desktop/2; 1.0)", wantOK: false},
		{name: "大小写变体不得归一化", ua: "CODEX_CLI_RS/1.0.0", wantOK: false},
		{name: "首段尾随空格不得重建", ua: "codex-tui /1.0.0", wantOK: false},
