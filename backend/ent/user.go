...
type UserEdges struct {
	...
	// ReusableInvitationCodeUses holds the value of the reusable_invitation_code_uses edge.
	ReusableInvitationCodeUses []*ReusableInvitationCodeUse `json:"reusable_invitation_code_uses,omitempty"`
...
// ReusableInvitationCodeUsesOrErr returns the ReusableInvitationCodeUses value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) ReusableInvitationCodeUsesOrErr() ([]*ReusableInvitationCodeUse, error) {
	if e.loadedTypes[13] {
		return e.ReusableInvitationCodeUses, nil
	}
	return nil, &NotLoadedError{edge: "reusable_invitation_code_uses"}
}
...
// QueryReusableInvitationCodeUses queries the "reusable_invitation_code_uses" edge of the User entity.
func (_m *User) QueryReusableInvitationCodeUses() *ReusableInvitationCodeUseQuery {
	return NewUserClient(_m.config).QueryReusableInvitationCodeUses(_m)
}
