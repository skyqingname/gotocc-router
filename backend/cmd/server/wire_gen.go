...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	openAIVideoBillingRepository := repository.NewOpenAIVideoBillingRepository(client, db)
