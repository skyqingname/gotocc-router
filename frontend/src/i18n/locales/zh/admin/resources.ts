export default {
    ...
    reusableInvitationCodes: {
      ...
      disable: '停用',
      disableTitle: '停用邀请码',
      disableConfirm: '确定停用这个邀请码吗？停用后新用户将无法继续使用它注册。',
      disableSuccess: '邀请码已停用',
      disableFailed: '停用邀请码失败',
      uses: '使用记录',
      usesTitle: '使用记录',
