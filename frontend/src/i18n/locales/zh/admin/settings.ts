export default {
    settings: {
      ...
      features: {
        ...
        affiliate: {
          generationRate: "第 {level} 代返佣比例",
          threeGenerationHint: "邀请链可持续延伸，每笔充值仅向最近三代持续返佣。缺失层级不补发。所有用户使用这三档比例，赠额和返佣转余额不再次分佣。",
          title: '邀请返利',
          description: '所有用户都可邀请他人；每笔有效充值向最近三代上游持续返佣。',
          enabled: '启用邀请返利',
          enabledHint: '关闭后邀请页面入口隐藏，新充值不产生返利；注册邀请关系仍会记录，已有返利额度可转入余额。',
          adminRechargeRebate: '管理员充值参与返利',
          adminRechargeRebateHint: '开启后，“用户管理 > 充值”按增加的站内 USD 代币参与三代返佣。赠额请用“设置余额”；设置余额和扣款不返佣。',
          rebateRate: '全局返利比例',
          ...
          customUsers: {
            title: '专属用户配置',
            description: '为指定用户设置专属邀请码。所有用户均按上方三代比例返佣。',
            addButton: '添加专属用户',
            ...
            resetMessage: '确认重置 {email} 的专属邀请码？已分发的旧 AFF 链接将失效，已有邀请关系保持不变。',
