export default {
  batchImage: {
    ...
    create: {
      ...
      selectKeyPlaceholder: '请选择 API Key',
      noKeysHint: '当前没有可用于批量生图的 API Key。请创建已启用批量生图的固定密钥，或选择支持批量生图的智能路由密钥。',
      model: '模型',
      imageSize: '图片尺寸',
    ...
    messages: {
      ...
      selectApiKey: '请选择可用的 API Key',
      autoRoutingUnsupported: '该智能路由密钥当前没有可用的批量生图端点',
