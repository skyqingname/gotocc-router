export default {
  ...
  affiliate: {
    ...
    agent: {
      title: "Agent Center",
      applyTitle: "Become an agent",
      applyDescription: "Apply to activate immediately, with no review. Eligible referral top-ups earn commissions from activation onward; earlier top-ups are not credited. Membership cannot be cancelled.",
      applyButton: "Become an agent",
      applying: "Activating...",
      applied: "Agent membership activated",
      applyFailed: "Activation failed. Please retry.",
      appliedAt: "Activated: {time}",
      loadFailed: "Failed to load agent status",
    },
    tips: {
      title: 'How It Works',
      line1: 'Share your invitation code or invite link with new users.',
