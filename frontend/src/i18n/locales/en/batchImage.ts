export default {
  batchImage: {
    ...
    create: {
      ...
      selectKeyPlaceholder: 'Select an API key',
      noKeysHint: 'No API key is available for batch image generation. Create a fixed eligible key or select a smart-routing key with batch image support.',
      model: 'Model',
    ...
    messages: {
      ...
      selectApiKey: 'Select an available API key.',
      autoRoutingUnsupported: 'This smart-routing key currently has no eligible batch image endpoint.',
