export default {
    settings: {
      ...
      features: {
        ...
        affiliate: {
          generationRate: "Generation {level} commission rate",
          threeGenerationHint: "Invitation chains can grow without limit. Each recharge pays the nearest three generations. Missing generations receive no payout. These rates apply to everyone; gifts and commission transfers earn no further commission.",
          title: 'Affiliate (Invite Rebate)',
          description: 'Every account can invite others. Each valid recharge pays its nearest three ancestors.',
          enabled: 'Enable Affiliate',
          enabledHint: 'When off, the affiliate menu is hidden and new recharges earn no commission. Signup relationships are still recorded and existing commission remains transferable.',
          adminRechargeRebate: 'Rebate Admin Deposits',
          adminRechargeRebateHint: 'When enabled, User Management > Deposit pays three-generation commission on the credited USD tokens. Use Set Balance for gifts; balance adjustments and withdrawals do not earn commission.',
          ...
          customUsers: {
            ...
            description: 'Set custom invite codes. All users share the three generation rates above.',
            ...
            resetMessage: 'Reset the custom invite code for {email}? Previously shared AFF links will stop working. Existing inviter relationships stay unchanged.',
