export default {
    ...
    reusableInvitationCodes: {
      ...
      ownerHint: "Find the ID in user management. Leave empty for registration only. The same code registers users and assigns referral ownership.",
      ...
      description: 'Manage codes for registration and referral ownership',
      create: 'Create invitation code',
      createTitle: 'Create invitation code',
      ...
      disable: 'Disable',
      disableTitle: 'Disable invitation code',
      disableConfirm: 'Disable this invitation code? New users will no longer be able to register with it.',
      disableSuccess: 'Invitation code disabled',
      disableFailed: 'Failed to disable invitation code',
      uses: 'Usage records',
