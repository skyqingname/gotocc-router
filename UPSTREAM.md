...
| `v0.2.1+custom.006` | `v0.2.1` | `578785ee7fb35030b094b69624efe25670a36f5f` | planned |
...
```text
Git/GitHub: v0.2.1+custom.006
Application: 0.2.1+custom.006
OCI naming: v0.2.1-custom.006 (no image published by the local archive workflow)
```
