...
The owned candidate is based on Plus `v0.2.4+custom.001`, commit
`92e12acd4b39f030b56e635bcc02e239e14843e9`, with GoToCC contracts carried
...
OCI naming: v0.2.4-custom.002 (no image published by the local archive workflow)
```
