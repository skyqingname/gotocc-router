...
The owned candidate `v0.2.8+custom.002` is based on the complete Plus
`v0.2.8+custom.001` tree, commit `0f4a93bd27868c6c48bf26a803546d0023784665`.
It preserves the active GoToCC contracts and the unified invitation / immediate
agent enrollment work from local `v0.2.7+custom.005`. Commission visibility
depends only on agent membership, never on ownership of a permanent code.
...
| `v0.2.7+custom.005` | `v0.2.7` | `aea725f2ea644d5592d0bbb1d63b607efa7e200a` | local candidate; unified invitations and agent opt-in |
| `v0.2.8+custom.002` | `v0.2.8` | `fd80b08c90b55edcad5b00171b53f08721d30da1` | local candidate; Plus v0.2.8+custom.001 |
...
OCI naming: v0.2.8-custom.002 (no image published by the local archive workflow)
```
